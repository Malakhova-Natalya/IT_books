...
`Profit and Loss Fact Tables Using Allocations`. Таблицы фактов, которые представляют полное уравнение прибыли - один из главных результатов DW/BI системы. Уравнение прибыли это `revenue - costs = profit`.
