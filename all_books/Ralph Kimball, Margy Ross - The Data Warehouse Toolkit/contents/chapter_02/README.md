...
Одно из важных достижений подхода многомерного моделирования - определение простого, но мощного рецепта интеграции данных различных бизнес-процессов.
...
`Enterprise Data Warehouse Bus Matrix`. Это незаменимый инструментдля создания и взаимодействия с архитектурой хранилища данных (`Enterprise Data Warehouse Bus Architecture`). Строки матрицы - бизнес-процессы, столбцы - измерения.

**Детальная матрица реализации шины**
