...
`Drilling Across`. Это значит создание отдельных запросов для двух и более таблиц фактов, где заголовки строк каждого запроса состоят из идентичных согласованных измерений. Вендоры BI 
